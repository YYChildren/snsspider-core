...
import com.mingchao.snsspider.logging.impl.CommonsLoggingLogProvider;
...
public class LogFactory {
  ...
  public static String[][] replacements = { { "net.javacoding.jspider.", "" } };

  protected static Map<String, Log> loggers = new HashMap<String, Log>();
  ...
  protected LogFactory() {
     ...
     * PropertySet logProps = new MappedPropertySet ( ConfigConstants.CONFIG_LOG, props); Class<?>
     * providerClass = logProps.getClass(ConfigConstants.CONFIG_LOG_PROVIDER,
     * SystemOutLogProvider.class); try { provider = (LogProvider) providerClass.newInstance(); }
     * catch (InstantiationException e) { // CANNOT HAPPEN - WE CHECKED BEFORE } catch
     * (IllegalAccessException e) { // SHOULDN'T HAPPEN - NOT GONNA HANDLE IT }
     */
    provider = new CommonsLoggingLogProvider();
  }
